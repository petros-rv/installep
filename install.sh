...
then
		...
		then
			...
			apt-get remove chromium-gost -y
		...
		echo -e "\033[0m "
		echo " "
		echo -e "\e[1;93m3. Запускаем интерфейс PCSC"
		echo " "
		echo -e "\033[0m "
		sleep 3
		...
		echo -e "\033[0m "
		echo " "
		echo -e "\e[1;93m4. Загружаем и устанавливаем плагин для работы на сайте gosuslugi.ru"
		echo " "
		echo -e "\033[0m "
		...
		echo -e "\033[0m "
		echo " "
		echo -e "\e[1;93m5. Скачиваем ifcx64.cfg"
		echo " "
		echo -e "\033[0m "
		sleep 3
		mkdir /tmp/SXG/IFCX
		...
		echo -e "\033[0m "
		echo " "
		echo -e "\e[1;93m1. Установим пакеты КриптоПро CSP"
		echo -e "\033[0m "
		echo " "
		sleep 3
		apt-get install -y cryptopro-preinstall
